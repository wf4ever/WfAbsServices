...
public class RunExample {
	...
	public String runExample(String wfRun){
		...
		//set nombre del workflow
		this.setWfName(wfRun);
	...
	private void setWfName(String wfRun) {
		String rdf=null;
		rdf=rQ.runQuery(q.getWorkflow(wfRun));
		...
		while (scanner.hasNextLine()) {
		  ...
		  if (extractor.checkAppereance(line, "wf")){
			  wf=extractor.SimpleExtract(line);
			  content.setWfName(wf);
		  }
		}
